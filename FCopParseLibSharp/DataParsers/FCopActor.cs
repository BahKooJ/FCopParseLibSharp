...
namespace FCopParser {
    ...
    public abstract class FCopEntity : FCopActorBehavior {
        ...
        public ValueActorProperty u_miniMapColor;
        ...
        List<ActorProperty> InitEntityProperties() {
            ...
            u_miniMapColor = new("Minimap Color (Unknown)", Read8(), BitCount.Bit8);
            ...
            return new List<ActorProperty>() {
                health, collideDamage, u_team, u_miniMapColor, u_unknown15, u_explosion, uvOffset
            };
        ...
        List<ActorProperty> InitEmptyEntityProperties() {
            ...
            u_miniMapColor = new("Minimap Color (Unknown)", 0, BitCount.Bit8);
